...
require("clangd_extensions").setup({
    inlay_hints = {
        ...
        only_current_line_autocmd = { "TextChangedI", "TextChanged"},
...
nnoremap <leader>bd <cmd>make<cr>
...
autocmd Filetype cpp setlocal makeprg=/usr/bin/g++\ %\ -g\ -DLEETCODE\ -o\ %.exe\ -fsanitize=address,undefined
autocmd Filetype rust nnoremap <Leader>d :RustDebuggables <CR>


if has("autocmd")
  augroup templates
    autocmd BufNewFile *.cpp 0r ~/.config/nvim/cpp.skl
  augroup END
endif
